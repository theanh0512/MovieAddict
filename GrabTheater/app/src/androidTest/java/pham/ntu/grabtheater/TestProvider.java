...
import pham.ntu.grabtheater.data.MovieProvider;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void deleteAllRecordsFromProvider() {
        ...
        mContext.getContentResolver().delete(
                MovieContract.NơwPlayingEntry.CONTENT_URI,
                null,
                null
        );
        ...
        assertEquals("Error: Records not deleted from Now Playing table during delete", 0, cursor.getCount());
        cursor.close();
    }
    ...
    public void testGetType() {
        ...
        assertEquals("Error: the MoiveEntry CONTENT_URI should return MoiveEntry.CONTENT_TYPE",
                MovieContract.MovieEntry.CONTENT_TYPE, type);

        String page_number = "1";
        // content://com.example.android.sunshine.app/weather/94074
        type = mContext.getContentResolver().getType(
                MovieContract.NơwPlayingEntry.buildNowPlayingUri(123));
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI with location should return WeatherEntry.CONTENT_TYPE",
                MovieContract.NơwPlayingEntry.CONTENT_TYPE, type);
    }
    ...
    public void testBasicWeatherQuery() {
        ...
        long locationRowId = TestUtilities.insertTestMovieValues(mContext);

        // Fantastic.  Now that we have a location, add some weather!
        ContentValues nowPlayingValues = TestUtilities.createNowPlayingValues(locationRowId);

        long nowPlayingRowId = db.insert(MovieContract.NơwPlayingEntry.TABLE_NAME, null, nowPlayingValues);
        assertTrue("Unable to Insert WeatherEntry into the Database", nowPlayingRowId != -1);

        db.close();

        // Test the basic content provider query
        Uri nowPlayingAtPageUri = MovieContract.NơwPlayingEntry.buildNowPlayingPage(1);
        Cursor nowPlayingCursor = mContext.getContentResolver().query(
                nowPlayingAtPageUri,
                null,
                null,
                null,
        ...
        Cursor testMovieCursor = mContext.getContentResolver().query(
                MovieContract.MovieEntry.CONTENT_URI,
                null,
                null,
                null,
        ...
        TestUtilities.validateCursor("testBasicWeatherQuery", nowPlayingCursor, nowPlayingValues);
        TestUtilities.validateCursor("testBasicWeatherQuery", testMovieCursor, testValues);
    }
